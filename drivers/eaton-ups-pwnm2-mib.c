...
static snmp_info_t pw_mib[] = {
	...
	/* WORKAROUND for NM2 card: use the "macaddr2" for version 2.X and
	 * "macaddr1" for all other version data (see treatment in snmp-ups.c).
	 *
	 * NOTE: It is important to not change the order of OID reading,
	 * the second one takes the priority when both are defined on
	 * the device.
	 */
	snmp_info_default("device.macaddr2", ST_FLAG_STRING, SU_INFOSIZE, ".1.3.6.1.2.1.2.2.1.6.3", "", SU_FLAG_OK | SU_FLAG_STATIC, NULL),
	snmp_info_default("device.macaddr1", ST_FLAG_STRING, SU_INFOSIZE, ".1.3.6.1.2.1.2.2.1.6.2", "", SU_FLAG_OK | SU_FLAG_STATIC, NULL),
