...
static hid_info_t mge_hid2nut[] =
{
	...
	*/
	...
	{ "experimental.ecomode.disable", 0, 0, "UPS.PowerConverter.Input.[5].Switchable", NULL, "0", HU_TYPE_CMD | HU_FLAG_HIDDEN, eaton_input_eco_mode_on_off_info },
	...
	{ "experimental.essmode.enable",  0, 0, "UPS.PowerConverter.Input.[5].Switchable", NULL, "2", HU_TYPE_CMD | HU_FLAG_HIDDEN, eaton_input_eco_mode_on_off_info },
	{ "experimental.essmode.disable", 0, 0, "UPS.PowerConverter.Input.[5].Switchable", NULL, "0", HU_TYPE_CMD | HU_FLAG_HIDDEN, eaton_input_eco_mode_on_off_info },
	/* Command to switch ECO(HE) Mode with switch to Automatic Bypass Mode on before */
	{ "experimental.ecomode.start.auto", 0, 0, "UPS.PowerConverter.Input.[5].Switchable", NULL, "1", HU_TYPE_CMD | HU_FLAG_HIDDEN, eaton_input_eco_mode_auto_on_off_info },
	/* Command to switch from ECO(HE) Mode with switch from Automatic Bypass Mode on before */
	{ "experimental.ecomode.stop.auto", 0, 0, "UPS.PowerConverter.Input.[5].Switchable", NULL, "0", HU_TYPE_CMD | HU_FLAG_HIDDEN, eaton_input_eco_mode_auto_on_off_info },
